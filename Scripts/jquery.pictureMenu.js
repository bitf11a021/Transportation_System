(function($) {
    jQuery.fn.pictureMenu = function(options) {
        var defaults = {
            ...
            menuHeight: 271,              // The height of the menu (usually the same as the height of the images)
            menuWidth: 46,                // The length of a menu item (useMenuWidth must be true)
            menuWidthHover: 46,           // The length of the inactive menu items
            menuActiveWidth: 600,         // The length of the active menu items (useMenuActiveWidth must be true)
